...
**Attach binaries** section when creating the release on GitHub. Generated
files in `build/` and `release/` are intentionally not committed to Git.
...
- Treat the displayed words as highly sensitive. Anyone who obtains the full
  mnemonic can control the wallet it protects.
